//https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=3151
#include <bits/stdc++.h>
...
int main() {
    ...
    for (int tt = 1; tt <= t; tt++) {
        int n, k;
        cin >> n >> k;
        cout << "Case " << tt << ": " << (k == 0 ? 1 : c[k - 1].solve(n)) << endl;
    }
    return 0;
}
